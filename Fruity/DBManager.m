...
-(instancetype)initWithDatabaseFilename:(NSString *)dbFilename{
    ...
    if (self) {
        ...
        // Copy the database filename into the documents directory if necessary.
...
-(void)runQuery:(const char *)query isQueryExecutable:(bool)queryExecutable {
    ...
    if (openDatabaseResult == SQLITE_OK) {
        // Declare a sqlite3_stmt object in which will be stored the query after having been compiled into a SQL statement.
